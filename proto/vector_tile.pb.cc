...
PROTOBUF_CONSTEXPR Tile_Feature::Tile_Feature(::_pbi::ConstantInitialized)
    : _impl_{
      ...
      /* _impl_._geometry_cached_byte_size_ = */ {0},
...
Tile_Value::Tile_Value(const Tile_Value& from) : ::google::protobuf::MessageLite() {
...
Tile_Feature::Tile_Feature(const Tile_Feature& from) : ::google::protobuf::MessageLite() {
...
::uint8_t* Tile_Feature::_InternalSerialize(
  ...
  // repeated uint32 tags = 2 [packed = true];
  {
    ...
    if (byte_size > 0) {
      target = stream->WriteUInt32Packed(2, _internal_tags(),
                                                 byte_size, target);
    }
  }
  ...
  // repeated uint32 geometry = 4 [packed = true];
  {
    ...
    if (byte_size > 0) {
      target = stream->WriteUInt32Packed(4, _internal_geometry(),
                                                 byte_size, target);
    }
  }
...
Tile_Layer::Tile_Layer(const Tile_Layer& from) : ::google::protobuf::MessageLite() {
...
Tile::Tile(const Tile& from) : ::google::protobuf::MessageLite() {
