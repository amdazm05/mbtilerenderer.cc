...
#ifndef GOOGLE_PROTOBUF_INCLUDED_vector_5ftile_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_vector_5ftile_2eproto_2epb_2eh
...
class Tile_Value final :
    public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:vector_tile.Tile.Value) */ {
 public:
  ...
  Tile_Value* New(::google::protobuf::Arena* arena = nullptr) const final {
...
class Tile_Feature final :
    public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:vector_tile.Tile.Feature) */ {
 public:
  ...
  Tile_Feature* New(::google::protobuf::Arena* arena = nullptr) const final {
 ...
 private:
  ...
  struct Impl_ {
    ...
    mutable ::google::protobuf::internal::CachedSize _geometry_cached_byte_size_;
    ::uint64_t id_;
    int type_;
    PROTOBUF_TSAN_DECLARE_MEMBER
  };
...
class Tile_Layer final :
    public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:vector_tile.Tile.Layer) */ {
 public:
  ...
  Tile_Layer* New(::google::protobuf::Arena* arena = nullptr) const final {
...
class Tile final :
    public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:vector_tile.Tile) */ {
 public:
...
inline const ::google::protobuf::RepeatedField<::uint32_t>& Tile_Feature::_internal_tags() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return _impl_.tags_;
}
...
inline const ::google::protobuf::RepeatedField<::uint32_t>& Tile_Feature::_internal_geometry() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
...
inline void Tile_Layer::set_keys(int index, absl::string_view value) {
  _internal_mutable_keys()->Mutable(index)->assign(value.data(),
                                                     value.size());
  // @@protoc_insertion_point(field_set_string_piece:vector_tile.Tile.Layer.keys)
}
...
inline void Tile_Layer::add_keys(const char* value, std::size_t size) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _internal_mutable_keys()->Add()->assign(
      reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:vector_tile.Tile.Layer.keys)
}
inline void Tile_Layer::add_keys(absl::string_view value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _internal_mutable_keys()->Add()->assign(value.data(), value.size());
  // @@protoc_insertion_point(field_add_string_piece:vector_tile.Tile.Layer.keys)
}
...
inline ::google::protobuf::RepeatedPtrField<std::string>* Tile_Layer::mutable_keys() {
...
inline void Tile::clear_layers() {
  _internal_mutable_layers()->Clear();
}
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_vector_5ftile_2eproto_2epb_2eh
